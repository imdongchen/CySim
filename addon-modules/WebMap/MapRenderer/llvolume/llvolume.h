...
public:
	...
	LLPathParams(U8 curve, U16 begin, U16 end, U8 scx, U8 scy, U8 shx, U8 shy, U16 twistend, U16 twistbegin, U16 radiusoffset, U16 tx, U16 ty, U8 revolutions, U16 skew)
	{
		mCurveType = curve;
		mBegin = (F32)(begin * CUT_QUANTA);
		mEnd = (F32)(1.f - end * CUT_QUANTA);
		if (mEnd > 1.f)
			mEnd = 1.f;
